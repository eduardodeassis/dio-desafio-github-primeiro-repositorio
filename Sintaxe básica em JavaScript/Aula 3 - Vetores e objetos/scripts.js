...
//array.splice(0, 3);
//console.log(array);
//remove os índices e insere os novos
array.splice(0,3,'novaString',1234,false,[1,2,3]);
console.log(array);
...
let object = { propriedade1: 'valor1', propriedade2: 'valor2', imprimir: function () {console.log(this.propriedade1 + ' - ' + this.propriedade2);} }
